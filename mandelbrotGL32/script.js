...
function drawMandelbrot(gl, programInfo, buffers, mandelBounds) {
	...
	console.log("World: [" + (mandelBounds.minX / scalingFactor[0] + translationVector[0]) + ", " + (mandelBounds.minY / scalingFactor[1] + translationVector[1]) + "], [" + (mandelBounds.maxX / scalingFactor[0] + translationVector[0]) + ", " + (mandelBounds.maxY / scalingFactor[1] + translationVector[1]) + "]");
...
function main() {
	...
	document.addEventListener('mouseup', function(e) {
		if (e.button == 0) {
			...
			translationVector[0] = translationVector[0] - map(dragX, -gl.canvas.clientWidth/2, gl.canvas.clientWidth/2, mandelBounds.minX, mandelBounds.maxX) / scalingFactor[0];
		...
		if (e.button == 1 || e.button == 2) {
			console.log({
				...
				world: [
					map(e.clientX, 0, gl.canvas.clientWidth, mandelBounds.minX, mandelBounds.maxX) / scalingFactor[0] + translationVector[0], 
